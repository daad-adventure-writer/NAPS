...
\sistemas{\quill, \paw y \daad versión 1}
...
Esta tabla de procesos es la tabla de respuestas en \paw y la versión 1 de \daad. En la versión 2 de \daad, esta tabla es el bucle principal de la aventura, el punto de inicio y fin del programa.
