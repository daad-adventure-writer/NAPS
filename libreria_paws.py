...
def guarda_codigo_fuente (fichero):
  ...
  - Recibe como primer parámetro un fichero abierto
  - Devuelve False si ha ocurrido algún error"""
  return alto_nivel.guarda_codigo_fuente (fichero, NOMBRE_SISTEMA, NOMB_COMO_VERB, PREP_COMO_VERB, abreviaturas, atributos, [], condactos, conexiones, desc_locs, desc_objs, locs_iniciales, msgs_usr, msgs_sys, nombres_objs, False, num_objetos, tablas_proceso, vocabulario, lee_secs_ctrl)
